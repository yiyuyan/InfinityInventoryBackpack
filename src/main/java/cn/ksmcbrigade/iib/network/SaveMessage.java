...
public record SaveMessage(int index, Collection<ItemStack> stacks) {
    public static void encode(SaveMessage message, FriendlyByteBuf buf){
        try {
    ...
    public static SaveMessage decode(FriendlyByteBuf friendlyByteBuf){
        ...
        return new SaveMessage(index,stacks1);
    }
}
